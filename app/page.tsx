...
export default function Home() {
  return (<>
    <div className="relative bg-gradient-to-b from-slate-800 to-[#08201D] h-screen">
        ...
        <div className="relative z-20 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-xl text-center">
            ...
            <div className="flex items-center justify-center mt-12">
              ...
              <Link href={"/auth/signin"} className="bg-white px-10 py-3 rounded-full font-semibold ml-2 cursor-pointer">Login</Link>
            </div>
